...
const NFAMembershipsDraftIndex = async ({ params, searchParams }) => {
	...
	const activateIt = async (id) => {
		...
		revalidatePath(
			`/nfabusiness/memberships/draft?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default NFAMembershipsDraftIndex;
