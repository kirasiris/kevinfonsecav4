...
const NFAProductsPublishedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/nfabusiness/products/published?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default NFAProductsPublishedIndex;
