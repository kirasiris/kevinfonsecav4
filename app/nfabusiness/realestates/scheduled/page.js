...
const NFARealEstatesScheduledIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/nfabusiness/realestates/scheduled?page=${page}&limit=${limit}&sort=${sort}`,
		);
	};
...
export default NFARealEstatesScheduledIndex;
