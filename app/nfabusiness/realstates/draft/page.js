...
const NFARealStatesDraftIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/nfabusiness/realstates/draft?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default NFARealStatesDraftIndex;
