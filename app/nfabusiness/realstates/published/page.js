...
const NFARealStatesPublishedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/nfabusiness/realstates/published?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default NFARealStatesPublishedIndex;
