...
const NFAReviewsTrashedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/nfabusiness/reviews/trashed?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default NFAReviewsTrashedIndex;
