...
const AdminForumsSearchIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/noadmin/forums/search?page=${page}&limit=${limit}&sort=${sort}${keywordQuery}`,
		);
	};
...
export default AdminForumsSearchIndex;
