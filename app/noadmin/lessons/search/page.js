...
const AdminLessonsSearchIndex = async ({ params, searchParams }) => {
	const lessons = await getLessons(
		`?keyword=${searchParams.keyword}&page=${searchParams.page}&limit=${searchParams.limit}&sort=${searchParams.sort}&onModel=Course`
	);
...
export default AdminLessonsSearchIndex;
