...
const AdminNewsletterEmailsIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/noadmin/newsletteremails?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default AdminNewsletterEmailsIndex;
