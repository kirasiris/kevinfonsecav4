...
async function getSecrets(params) {
	const res = await fetchurl(
		`/global/secrets${params}&status=scheduled`,
		"GET",
		"no-cache"
	);
	return res;
...
const AdminSecretsScheduledIndex = async ({ params, searchParams }) => {
	...
	return (
		<>
			...
			<Form
				...
				revalidateUrl={`/noadmin/secrets/scheduled?page=${page}&limit=${limit}&sort=${sort}`}
			/>
...
export default AdminSecretsScheduledIndex;
