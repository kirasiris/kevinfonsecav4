...
import CreateSnippetCategoryForm from "@/forms/noadmin/snippets/createsnippetcategoryform";

async function getCategories(params) {
	const res = await fetchurl(
		`/global/categories${params}&categoryType=snippet`,
		"GET",
		"no-cache"
	);
	return res;
