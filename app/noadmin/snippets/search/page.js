...
const AdminSnippetsSearchIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/noadmin/snippets/search?page=${page}&limit=${limit}&sort=${sort}${keywordQuery}`,
		);
	};
...
export default AdminSnippetsSearchIndex;
