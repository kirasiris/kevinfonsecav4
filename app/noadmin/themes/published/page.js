...
const AdminThemesPublishedIndex = async ({ params, searchParams }) => {
	const themes = await getThemes(
		`?page=${searchParams.page}&limit=${searchParams.limit}&sort=${searchParams.sort}&postType=theme&status=published`
	);
...
export default AdminThemesPublishedIndex;
